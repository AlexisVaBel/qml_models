...
public:
	virtual bool updateGrid(const QRectF& viewRect, const QQuickItem& container, const QQuickItem& navigable) noexcept;
...
public:
	...
	inline QColor getThickColor() const noexcept {
		return _thickColor;
	}
signals:
...
public:
	...
	inline qreal getGridWidth() const noexcept {
		return _gridWidth;
	}
signals:
...
public:
	...
	inline qreal getGridScale() const noexcept {
		return _gridScale;
	}
signals:
...
public:
	...
	inline int getGridMajor() const noexcept {
		return _gridMajor;
	}
signals:
